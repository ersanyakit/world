...
const Trade = () => {
  ...
  const [tokenSelector, setTokenSelector] = useState<{ showTokenSelector: boolean, side: TradeType,selected:Token | null }>({
              ...
              return (
                  ...
                  >
                      <div className="w-full flex flex-row gap-2 items-center justify-start">
                          <Image removeWrapper radius="full"
        ...
        <div className="relative w-full flex flex-col gap-2">
           ...
           endContent={
            ...
            <div className="absolute w-full flex flex-row top-[45px] z-[20] items-center flex flex-row gap-2 justify-center">
                ...
                <Button variant="faded" size="lg" radius="full" isIconOnly>
                <RefreshCcwDot />
                </Button>
                <Button onPress={()=>{
                    setTokenSelector(prevState => ({
            ...
            </div>
            {
                ...
                <TokenList onSelect={handleSelectToken}/>
            </div>
            }
