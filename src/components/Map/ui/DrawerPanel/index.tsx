...
import { useEffect } from "react";
  ...
  export default function DrawerPanel() {
    ...
    return (
      <div className="z-[99999] mt-[200px] absolute left-0">
        <Button
          color="primary"
          endContent={
        ...
        >
          <DrawerContent>
            {(onClose) => (
              <>
                <DrawerHeader className="absolute top-0 inset-x-0 flex flex-row gap-2 px-2 py-2 border-b border-default-200/50 justify-between bg-content1/50 backdrop-saturate-150 backdrop-blur-lg">
